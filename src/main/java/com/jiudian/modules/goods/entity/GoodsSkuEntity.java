...
public class GoodsSkuEntity implements Serializable {
	 ...
	 * goods标extends1
	 */
	private String goodsExtends1;
	
	
	
	/*--------- other -------*/
	@TableField(exist = false) 
	private BigDecimal memberPrice;   //规格会员价
	
	

	public String getGoodsExtends1() {
		return goodsExtends1;
	}
	public void setGoodsExtends1(String goodsExtends1) {
		this.goodsExtends1 = goodsExtends1;
	}
